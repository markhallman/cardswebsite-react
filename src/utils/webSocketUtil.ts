...
export const apiBaseUrl = isDevelopment ? 'http://localhost:8443' : 'https://coolestcardgames.com:8443';
export const websocketUrl = isDevelopment ? 'ws://localhost:8443/ws' : 'wss://coolestcardgames.com:8443/ws';
