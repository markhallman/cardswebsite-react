...
export const apiBaseUrl = isDevelopment ? 'https://localhost:8080' : 'https://coolestcardgames.com:8080';
export const websocketUrl = isDevelopment ? 'wss://localhost:8080/ws' : 'wss://coolestcardgames.com:8080/ws';
